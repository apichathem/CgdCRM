 ...
 * 
 */
public class ServiceRequestDTO extends BaseDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4008154396431004042L;
	...
	public void setSrNoteDescription(String srNoteDescription) {
		SrNoteDescription = srNoteDescription;
	}

	public Integer getSrContactId() {
		return srContactId;
	}

	public void setSrContactId(Integer srContactId) {
