			...
			<div class="row" style="display:none">
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="text" id='att_title' name='title' class="form-control"  data-rule-required="true" data-msg-required="Document Name is required." /> 
						</div>
					</div>
				</div>
			</div>
			<div class="row" style="display:none">
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="col-md-10">
							<textarea id='att_descp' name='descp' class="form-control" rows="3"></textarea> 
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row form-actions fluid">
				<div class="col-md-12">
					<div class="col-md-offset-3 col-md-9 text-right">
						<div class="btn-group">
							<button type="button" class="btn green" id="btn_fileNew" name="btn_attNew" style="display:none">
