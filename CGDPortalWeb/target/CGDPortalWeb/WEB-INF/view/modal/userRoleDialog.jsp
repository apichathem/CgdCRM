...
function searchUser(){
	...
	var param = "firstName="+firstName+"&lastName="+lastName+"&roleId="+roleId;
	oTableUser = ajaxDataTable($('#userDialogDataTable'), columnsUserDialog, 'getHigherUserList.htm', param, recordPerPageDialog, true, true);
}
